 ...
 * Enter command:getdistance Clementi BuonaVista Distance from Clementi to BuonaVista
 * is 12 
 * Enter command:getdistance clementi buonavista Distance from clementi to
...
public class CityConnect {
    ...
    private static int getPositionOfExistingRoute(String newStartLocation,
        ...
        for (int i = 0; i < route.length; i++) {
            ...
            if (existing_start_location == null) { // beginning of empty slots
                return NOT_FOUND;
            } else if (sameRoute(existing_start_location,
                    existing_end_location, newStartLocation, newEndLocation)) {
                return i;
            }
        }
        return NOT_FOUND;
    ...
    private static String addRoute(String userCommand) {
        ...
        int slotPosition = getSuitableLocationSlot(newStartLocation, newEndLocation);
    ...
    /**
     * Method to determine suitable slot between a the start ant end location
     * 
     * @param  newStartLocation     Start location
     * @param  newEndLocation       End location
     * 
     * @return Returns SLOT_UNAVAILABLE if
     *         no suitable slot is found.
     */
    private static int getSuitableLocationSlot(String newStartLocation, String newEndLocation) {
